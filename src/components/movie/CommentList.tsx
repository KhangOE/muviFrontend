...
export const CommentList = (props: { userName: string; text: string }) => {
  return (
    <div>
      <div className="text-white ">
        <div className="flex  items-top">
          ...
          <div className="pl-4 flex justify-between w-full pr-8 items-start">
            <div>
              <div className="font-bold">{props.userName}</div>
              <div className="">{props.text}t</div>
            </div>
          </div>
        </div>
      </div>
